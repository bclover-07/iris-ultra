...
class _QuizCamoScreenState extends ConsumerState<QuizCamoScreen> {
  ...
  void _loadDefaultQuestions() {
    final defaults = [
      ...
      QuizQuestion(
        id: 'q2',
        question: 'Which unit measures electric potential difference in Physics?',
      ...
      QuizQuestion(
        id: 'q3',
        question: 'What is the atomic symbol for Gold in Chemistry?',
        options: ['Au', 'Ag', 'Fe', 'Cu'],
        correctAnswer: 'Au',
      ...
      QuizQuestion(
        id: 'q4',
        question: 'What is the result of 7 % 3 (remainder operator)?',
        options: ['1', '2', '2.33', '0'],
        correctAnswer: '1',
        subject: 'STEM CS',
        difficulty: 'Easy',
